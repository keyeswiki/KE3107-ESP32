...
若串口监视器无内容显示，用手指按一下复位键，如下图所示(<span style="color: rgb(255, 76, 65);">将fox:bit摄像头模块拆下来时的操作</span>)：

![0906](../../img/0906.png)

若串口监视器无内容显示，用手指按一下复位键，如下图所示(<span style="color: rgb(255, 76, 65);">fox:bit摄像头模块没有拆下来时的操作</span>)：
