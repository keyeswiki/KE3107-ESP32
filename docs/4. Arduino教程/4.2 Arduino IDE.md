...
5\. 在开发板搜索框中，搜索 “**ESP32**”，点击安装最新版本，右下角可以看到开发板固件安装进度，等待几分钟安装完成。**安装过程中请保持网络稳定，如安装失败，请重复以上步骤，重新安装开发板固件即可。**
...
⚠️ **<span style="color: rgb(255, 76, 65);">特别提醒：假如，由于网络问题实在是下载安装不了ESP32开发板固件，我们也提供有ESP32开发板固件的压缩包，ESP32开发板固件的压缩包下载地址：</span>** [https://pan.baidu.com/s/1PGTfKZzxPtUpUcb3FqyZaA?pwd=3017](https://pan.baidu.com/s/1PGTfKZzxPtUpUcb3FqyZaA?pwd=3017) 
